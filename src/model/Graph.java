...
public class Graph {
	 ...
	 * Nachdem die Ergebnisliste fertiggestellt wurde, wird ihr erstes Element das aktuelle Element innerhalb dieser
	 * Liste.
	 */
	...
	private <T> List<T> copy (List<? extends T> src) {
		src.toFirst();
	...
	public void addVertex (Vertex pVertex) {
		if (pVertex.getID() != null && getVertex(pVertex.getID()) == null) {
	 ...
	 * im Graphen enthalten sind, nicht identisch sind und noch keine Kante zwischen den Knoten existiert. Ansonsten
	 * passiert nichts.
	 */
